...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ws(e,t,n){let r=new Float32Array(us),i=new V(0,1,0);return new xa({name:`SphericalGaussianBlur`,defines:{n:us,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ds(),fragmentShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Gc(i,i.VERTEX_SHADER,y),S=Gc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Zc(i,x,`vertex`),n=Zc(i,S,`fragment`);R(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        #settings-panel {
            ...
            border-image: url('${cg}') 11 fill repeat;
        ...
        #ui-settings-btn {
            ...
            border-image: url('${dg}') 11 fill repeat;
            image-rendering: pixelated;
            padding: 0;
            display: flex;
            align-items: center;
    ...
    `,document.head.appendChild(i);let a=document.createElement(`button`);a.id=`ui-settings-btn`,a.title=`Settings [Tab]`,a.innerHTML=`<img src="${fg}" alt=""><span>Settings [tab]</span>`,document.body.appendChild(a);let o=document.createElement(`div`);o.id=`settings-panel`,o.innerHTML=`
        <h2>Settings</h2>
    ...
    `,document.body.appendChild(o),o.querySelector(`#cfg-shadow`).value=String(e.shadowMapSize),o.querySelector(`#cfg-pan-speed`).addEventListener(`change`,t=>{e.panSpeed=Math.max(1,Number(t.target.value))}),o.querySelector(`#cfg-walk-speed`).addEventListener(`change`,t=>{e.walkSpeed=Math.max(1,Number(t.target.value))}),o.querySelector(`#cfg-move-speed`).addEventListener(`change`,t=>{e.moveSpeed=Math.max(1,Number(t.target.value))}),o.querySelector(`#cfg-shadow`).addEventListener(`change`,t=>{e.shadowMapSize=Number(t.target.value),r(e.shadowMapSize)}),o.querySelector(`#cfg-apply-obj`).addEventListener(`click`,()=>{e.objClusters=Number(o.querySelector(`#cfg-obj-clusters`).value),n()}),o.querySelector(`#cfg-apply-grass`).addEventListener(`click`,()=>{e.grassCount=Number(o.querySelector(`#cfg-count`).value),e.grassScaleMin=Number(o.querySelector(`#cfg-scale-min`).value),e.grassScaleMax=Number(o.querySelector(`#cfg-scale-max`).value),t()}),o.querySelector(`#cfg-close`).addEventListener(`click`,()=>{o.classList.remove(`visible`)}),a.addEventListener(`click`,()=>{o.classList.toggle(`visible`)}),window.addEventListener(`keydown`,e=>{e.code===`Tab`&&(e.preventDefault(),o.classList.toggle(`visible`))})}function xg(e){let t=[gg,_g,vg,yg],n=0,r=document.createElement(`style`);r.textContent=`
        .bld-tooltip {
        ...
        .bld-tt-shell {
            ...
            width: 44px;
            height: 44px;
            background: url('${pg}') center / 100% 100% no-repeat;
    ...
    `,document.head.appendChild(r);let i=e.map(e=>{let n=document.createElement(`div`);n.className=`bld-tooltip tt-hidden`;let r=document.createElement(`div`);r.className=`bld-tt-shell`;let i=document.createElement(`div`);i.className=`bld-tt-enter`;let a=document.createElement(`img`);a.src=mg,a.alt=``,i.appendChild(a);let o=document.createElement(`div`);return o.className=`bld-tt-border`,o.style.backgroundImage=`url('${t[0]}')`,r.appendChild(i),r.appendChild(o),n.appendChild(r),r.addEventListener(`mouseenter`,()=>n.classList.add(`tt-hovered`)),r.addEventListener(`mouseleave`,()=>n.classList.remove(`tt-hovered`)),{id:e,el:n,borderDiv:o}});return setInterval(()=>{n=(n+1)%t.length;let e=t[n];i.forEach(({borderDiv:t})=>{t.style.backgroundImage=`url('${e}')`})},150),{getElement(e){let t=i.find(t=>t.id===e);return t?t.el:null},update(e){e.forEach(({id:e,visible:t,isNear:n})=>{let r=i.find(t=>t.id===e);if(!r)return;let{el:a}=r;a.classList.toggle(`tt-hidden`,!t),a.classList.toggle(`tt-near`,n&&t)})}}}function Sg(){let e=document.createElement(`style`);e.textContent=`
        #book-panel {
            ...
            width: 480px;
            height: 360px;
            margin-left: ${-480/2}px;
            margin-top: ${-360/2}px;
            background: url('${hg}') center / 100% 100% no-repeat;
            image-rendering: pixelated;
            display: none;
    ...
    `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`book-panel`;let n=document.createElement(`button`);n.id=`book-panel-close`,n.textContent=`Close  [Esc]`,t.appendChild(n),document.body.appendChild(t);let r=!1,i=()=>{r&&(r=!1,t.style.transition=`transform 0.25s ease-in, opacity 0.2s ease`,t.style.transform=`scale(0.05)`,t.style.opacity=`0`,setTimeout(()=>{r||(t.style.display=`none`)},300))};return n.addEventListener(`click`,i),window.addEventListener(`keydown`,e=>{e.code===`Escape`&&i()}),{open(e,n){if(r)return;r=!0;let i=e-window.innerWidth/2+480/2,a=n-window.innerHeight/2+360/2;t.style.transformOrigin=`${i}px ${a}px`,t.style.transition=`none`,t.style.transform=`scale(0.05)`,t.style.opacity=`0`,t.style.display=`flex`,requestAnimationFrame(()=>{requestAnimationFrame(()=>{r&&(t.style.transition=`transform 0.45s cubic-bezier(0.34, 1.56, 0.64, 1), opacity 0.25s ease`,t.style.transform=`scale(1)`,t.style.opacity=`1`)})})},close:i,get isOpen(){return r}}}var Cg=20;function wg(e){let t=new Wp;t.gravity.set(0,0,0),t.allowSleep=!0,t.sleepSpeedLimit=.4,t.sleepTimeLimit=1.5,t.solver.iterations=40,t.solver.tolerance=.001;let n=new pf(`planet`),r=new pf(`object`),i=new X({mass:0,shape:new mf(e),position:new J(0,0,0)});i.material=n,t.addContactMaterial(new ff(n,r,{friction:.8,restitution:.1,contactEquationStiffness:1e8,contactEquationRelaxation:3})),t.addBody(i);function a(e,n){for(let e of n)if(e.body.sleepState<2){let t=e.body.position,n=t.length();if(n>.001){let r=-e.body.mass*Cg/n;e.body.force.set(t.x*r,t.y*r,t.z*r)}}t.step(1/60,e,3);for(let e of n){if(e.body.sleepState===2)continue;let t=e.body.position,n=t.length();if(n<e.groundDist&&n>.001){let r=e.groundDist/n;t.x*=r,t.y*=r,t.z*=r;let i=t.x/e.groundDist,a=t.y/e.groundDist,o=t.z/e.groundDist,s=e.body.velocity,c=s.x*i+s.y*a+s.z*o;c<0&&(s.x-=c*i,s.y-=c*a,s.z-=c*o)}}for(let e of n){if(e.body.sleepState===2)continue;let t=e.body.position,n=e.body.quaternion;if(e.mesh.quaternion.set(n.x,n.y,n.z,n.w),Math.abs(e.meshOriginOffset)>1e-4){let r=2*(n.x*n.y-n.w*n.z),i=1-2*(n.x*n.x+n.z*n.z),a=2*(n.y*n.z+n.w*n.x),o=e.meshOriginOffset;e.mesh.position.set(t.x-r*o,t.y-i*o,t.z-a*o)}else e.mesh.position.set(t.x,t.y,t.z);let r=t.length();r>.001&&e.surfaceNormal.set(t.x/r,t.y/r,t.z/r)}}return{physicsWorld:t,objectMaterial:r,stepPhysics:a}}var Tg=16,Eg=3,Dg=6,Og=.4,kg=6,Ag=4,jg=2,Mg=10,Ng=3,Pg=1.5,Fg=50,Ig=2,Lg=1,Rg=2.5,zg=Ig*.45,Bg=Ig*.35,Vg=1e4,Hg=1,Ug=2,Wg=.3,Gg=.5,Kg=0,qg=2,Jg=.5*qg,Yg=.5*qg,Xg=1.75*qg,Zg=2,Qg=new V(Math.sin(Gg)*Math.cos(Wg),Math.cos(Gg),Math.sin(Gg)*Math.sin(Wg)).normalize(),$g=Math.cos(Yg/Tg),e_=Qg.clone().multiplyScalar(Tg+Zg),t_={shadowMapSize:2048,grassCount:Vg,grassScaleMin:Hg,grassScaleMax:Ug,panSpeed:4,walkSpeed:1,moveSpeed:1,objClusters:Fg},n_=new zn,{physicsWorld:r_,objectMaterial:i_,stepPhysics:a_}=wg(Tg);document.body.style.backgroundColor=`#000814`;var o_=new go(60,window.innerWidth/window.innerHeight,.01,1e3),s_=new fu({antialias:!0,alpha:!0});s_.setSize(window.innerWidth,window.innerHeight),s_.setPixelRatio(window.devicePixelRatio),s_.shadowMap.enabled=!0,s_.shadowMap.type=2,s_.domElement.style.cssText=`position:absolute;top:0;left:0;z-index:1;`,document.body.appendChild(s_.domElement);var c_=new mh;c_.setSize(window.innerWidth,window.innerHeight),c_.domElement.style.cssText=`position:absolute;top:0;left:0;z-index:3;pointer-events:none;`,document.body.insertBefore(c_.domElement,s_.domElement);{let e=new Float32Array(6e3);for(let t=0;t<6e3;t+=3){let n=new V(Math.random()-.5,Math.random()-.5,Math.random()-.5).normalize(),r=300+Math.random()*200;e[t]=n.x*r,e[t+1]=n.y*r,e[t+2]=n.z*r}let t=new Nr;t.setAttribute(`position`,new vr(e,3)),n_.add(new aa(t,new ea({color:16777215,size:.8})))}n_.add(new wo(8952251,.8));var l_=new Co(16775392,2.5);l_.position.set(40,30,20),l_.castShadow=!0,l_.shadow.mapSize.setScalar(2048),l_.shadow.camera.near=1,l_.shadow.camera.far=200,l_.shadow.camera.left=l_.shadow.camera.bottom=-(Tg*2.5),l_.shadow.camera.right=l_.shadow.camera.top=Tg*2.5,l_.shadow.bias=-5e-4,l_.shadow.normalBias=.05,n_.add(l_);var u_=new lm;u_.load($h,e=>{let t=e.scene;t.scale.setScalar(Tg),t.traverse(e=>{e.isMesh&&(e.receiveShadow=!0)}),n_.add(t)},void 0,e=>console.error(`world:`,e));var d_=new Ft,f_=new Ft,p_=new V(0,1,0),m_=new An,h_=null,g_=null;function __(){if(!h_)return;g_&&=(n_.remove(g_),g_.dispose(),null);let e=t_.grassCount;if(e<=0)return;let t=new ji(h_.geometry,h_.material,e);t.receiveShadow=!0,t.castShadow=!1;for(let n=0;n<e;n++){let e=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1),i=new V(Math.sin(r)*Math.cos(e),Math.cos(r),Math.sin(r)*Math.sin(e));if(i.dot(Qg)>$g){n--;continue}d_.setFromUnitVectors(p_,i),f_.setFromAxisAngle(i,Math.random()*Math.PI*2),m_.position.copy(i).multiplyScalar(Tg),m_.quaternion.copy(f_).multiply(d_),m_.scale.setScalar(t_.grassScaleMin+Math.random()*(t_.grassScaleMax-t_.grassScaleMin)),m_.updateMatrix(),t.setMatrixAt(n,m_.matrix)}g_=t,n_.add(t)}u_.load(eg,e=>{e.scene.traverse(e=>{e.isMesh&&!h_&&(h_=e)}),__()},void 0,e=>console.error(`grass:`,e)),u_.load(tg,e=>{let t=e.scene;t.scale.setScalar(qg);let n=new Ft().setFromUnitVectors(new V(0,1,0),Qg),r=new Ft().setFromAxisAngle(Qg,Kg);t.quaternion.copy(r).multiply(n),t.position.copy(Qg).multiplyScalar(Tg),t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),n_.add(t)},void 0,e=>console.error(`school:`,e));var v_=null,y_=[],b_=null,x_=null,S_=Math.cos(Rg/Tg),C_=Math.cos(zg/Tg);function w_(){if(!b_||!x_)return;v_&&=(n_.remove(v_),null);for(let e of y_)r_.removeBody(e.body);y_=[];let e=t_.objClusters;if(e<=0)return;v_=new jn;let t=[b_,x_],n=new V,r=new V,i=Ig*.4*2,a=Lg+i,o=Math.cos(a/Tg),s=Math.cos(i/Tg),c=[];for(let i=0;i<e;i++){let e,i,a=0,l=!1;do{if(e=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),n.set(Math.sin(i)*Math.cos(e),Math.cos(i),Math.sin(i)*Math.sin(e)),a++,n.dot(Qg)>S_||c.some(e=>e.dot(n)>o))continue;l=!0}while(!l&&a<100);if(!l)continue;c.push(n.clone());let u=t[Math.floor(Math.random()*t.length)],d=1+Math.floor(Math.random()*4),f=[];for(let e=0;e<d;e++){let e=null;for(let t=0;t<20;t++){r.set(Math.random()-.5,Math.random()-.5,Math.random()-.5).addScaledVector(n,-r.dot(n)).normalize();let t=Math.random()*Lg/Tg,i=n.clone().applyQuaternion(new Ft().setFromAxisAngle(r,t)).normalize();if(!f.some(e=>e.dot(i)>s)){e=i,f.push(i);break}}if(!e)continue;let t=u[Math.floor(Math.random()*u.length)],i=t.clone(),a=new Ft().setFromUnitVectors(new V(0,1,0),e),o=new Ft().setFromAxisAngle(e,Math.random()*Math.PI*2);i.quaternion.copy(o).multiply(a);let c=(t.userData.halfExtents??new V(Bg,Bg,Bg)).clone().multiplyScalar(Ig),l=Tg+c.y,d=(t.userData.bboxCenterY??0)*Ig,p=l-d;i.position.copy(e).multiplyScalar(p),i.scale.setScalar(Ig),v_.add(i);let m=new X({mass:1,shape:new Pu(new J(c.x,c.y,c.z)),material:i_,linearDamping:.4,angularDamping:.8});m.position.set(e.x*l,e.y*l,e.z*l),m.quaternion.set(i.quaternion.x,i.quaternion.y,i.quaternion.z,i.quaternion.w),r_.addBody(m),m.sleep(),y_.push({body:m,mesh:i,surfaceNormal:e.clone(),colliding:!1,groundDist:l,meshOriginOffset:d})}}n_.add(v_)}{let e=e=>new Promise((t,n)=>u_.load(e,e=>t(e.scene),void 0,n));Promise.all([e(ng),e(rg),e(ig),e(ag),e(og),e(sg)]).then(([e,t,n,r,i,a])=>{let o=new V,s=new V,c=new er;[e,t,n,r,i,a].forEach(e=>{e.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),c.setFromObject(e),c.getSize(o),c.getCenter(s),e.userData.halfExtents=o.clone().divideScalar(2),e.userData.bboxCenterY=s.y}),b_=[e,t],x_=[n,r,i,a],w_()}).catch(e=>console.error(`random_objects:`,e))}var Q=Zh(s_.domElement,t_,Og,Mg),T_=new V(0,Tg,0),E_=new V(1,0,0),$=new V,D_=new V,O_=new V,k_=new V,A_=new V,j_=new V,M_=new Ft,N_=new W,P_=new V,F_=new V,I_=null,L_=!1,R_=0;u_.load(Qh,e=>{let t=e.scene;t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)});let n=new qo(t),r=n.clipAction(e.animations[0]);r.play(),r.timeScale=Ag*t_.walkSpeed,r.paused=!0,n_.add(t),I_={model:t,mixer:n,action:r}},void 0,e=>console.error(`walk:`,e)),window.addEventListener(`resize`,()=>{o_.aspect=window.innerWidth/window.innerHeight,o_.updateProjectionMatrix(),s_.setSize(window.innerWidth,window.innerHeight),c_.setSize(window.innerWidth,window.innerHeight)});var z_=new Jo;bg(t_,{onGrassApply:__,onObjApply:w_,onShadowChange:e=>{e===0?l_.castShadow=!1:(l_.castShadow=!0,l_.shadow.mapSize.setScalar(e),l_.shadow.map&&(l_.shadow.map.dispose(),l_.shadow.map=null))}});var B_=xg([`school`]),V_=Sg(),H_=new zn,U_=new dh(B_.getElement(`school`));U_.scale.set(.01,.01,.01),U_.position.copy(e_),H_.add(U_);var W_=1/0;B_.getElement(`school`).querySelector(`.bld-tt-shell`).addEventListener(`click`,e=>{V_.isOpen||V_.open(e.clientX,e.clientY)}),window.addEventListener(`keydown`,e=>{if(e.code===`Enter`&&W_<Xg&&!V_.isOpen){let e=e_.clone().project(o_),t=(e.x*.5+.5)*window.innerWidth,n=(-e.y*.5+.5)*window.innerHeight;V_.open(t,n)}});function G_(){requestAnimationFrame(G_);let e=Math.min(z_.getDelta(),.05);if(!I_){s_.render(n_,o_);return}$.copy(T_).normalize(),Q.currentUp.copy($),Q.initialised||=(Q.baseDir.set(0,0,1).addScaledVector($,-$.z).normalize(),Q.savedBaseDir.copy(Q.baseDir),!0),E_.addScaledVector($,-E_.dot($)).normalize(),O_.copy(Q.baseDir).negate(),k_.crossVectors(O_,$).normalize(),A_.set(0,0,0),Yh.has(`KeyW`)&&A_.add(O_),Yh.has(`KeyS`)&&A_.sub(O_),Yh.has(`KeyA`)&&A_.sub(k_),Yh.has(`KeyD`)&&A_.add(k_),(Xh.x!==0||Xh.y!==0)&&(A_.addScaledVector(O_,Xh.y),A_.addScaledVector(k_,Xh.x));let t=A_.lengthSq()>0,n=t&&Yh.has(`ShiftLeft`)?jg:1;if(t!==L_&&(L_=t,I_.action.paused=!t,t||(I_.action.time=0,I_.mixer.update(0),R_=0)),I_.action.timeScale=Ag*t_.walkSpeed*n,t){R_=Math.min(R_+e,Ng);let t=1+R_/Ng*Pg;A_.normalize();let r=Math.max(-1,Math.min(1,E_.dot(A_)));r<.9999&&(j_.crossVectors(E_,A_).normalize(),M_.setFromAxisAngle(j_,Math.min(Math.acos(r),Dg*e)),E_.applyQuaternion(M_).normalize()),j_.crossVectors($,A_).normalize(),M_.setFromAxisAngle(j_,t_.moveSpeed*Eg*t*n*e/Tg),T_.applyQuaternion(M_).setLength(Tg),E_.applyQuaternion(M_).normalize(),Q.baseDir.applyQuaternion(M_).normalize(),Q.savedBaseDir.applyQuaternion(M_).normalize()}$.copy(T_).normalize(),E_.addScaledVector($,-E_.dot($)).normalize(),Q.baseDir.addScaledVector($,-Q.baseDir.dot($)).normalize(),Q.savedBaseDir.addScaledVector($,-Q.savedBaseDir.dot($)).normalize();let r=$.dot(Qg),i=Math.acos(Math.max(-1,Math.min(1,r)))*Tg;W_=i,i<Jg&&i>1e-4&&(j_.crossVectors(Qg,$).normalize(),M_.setFromAxisAngle(j_,Jg/Tg),T_.copy(Qg).multiplyScalar(Tg).applyQuaternion(M_).setLength(Tg),$.copy(T_).normalize(),E_.addScaledVector($,-E_.dot($)).normalize(),Q.baseDir.addScaledVector($,-Q.baseDir.dot($)).normalize(),Q.savedBaseDir.addScaledVector($,-Q.savedBaseDir.dot($)).normalize()),a_(e,y_);for(let e of y_){let t=e.surfaceNormal,n=$.dot(t)>C_;if(n&&(j_.crossVectors(t,$).normalize(),M_.setFromAxisAngle(j_,zg/Tg),T_.copy(t).multiplyScalar(Tg).applyQuaternion(M_).setLength(Tg),$.copy(T_).normalize(),E_.addScaledVector($,-E_.dot($)).normalize(),Q.baseDir.addScaledVector($,-Q.baseDir.dot($)).normalize(),Q.savedBaseDir.addScaledVector($,-Q.savedBaseDir.dot($)).normalize(),!e.colliding)){e.body.wakeUp();let n=t.x-$.x,r=t.y-$.y,i=t.z-$.z,a=n*t.x+r*t.y+i*t.z,o=n-t.x*a,s=r-t.y*a,c=i-t.z*a,l=Math.sqrt(o*o+s*s+c*c);l>.001&&(o/=l,s/=l,c/=l),e.body.applyImpulse(new J((o*.7+t.x*.4)*10,(s*.7+t.y*.4)*10,(c*.7+t.z*.4)*10))}e.colliding=n}Q.snapBack&&!Q.isOrbiting&&(Q.baseDir.lerp(Q.savedBaseDir,Math.min(1,kg*e)).normalize(),Q.pitch=Pt.lerp(Q.pitch,Q.savedPitch,Math.min(1,kg*e)),Q.baseDir.dot(Q.savedBaseDir)>.9999&&Math.abs(Q.pitch-Q.savedPitch)<.001&&(Q.snapBack=!1)),D_.crossVectors($,E_).normalize(),N_.makeBasis(D_,$,E_),I_.model.quaternion.setFromRotationMatrix(N_),I_.model.position.copy(T_),I_.mixer.update(e),P_.copy(T_).addScaledVector(Q.baseDir,Q.dist*Math.cos(Q.pitch)).addScaledVector($,Q.dist*Math.sin(Q.pitch)),o_.position.lerp(P_,Math.min(1,8*e)),o_.up.copy($),F_.copy(T_).addScaledVector($,.8),o_.lookAt(F_),U_.quaternion.copy(o_.quaternion),B_.update([{id:`school`,visible:Qg.dot(o_.position)>0,isNear:i<Xg}]),s_.render(n_,o_),c_.render(H_,o_),console.log(V_.isOpen)}G_();